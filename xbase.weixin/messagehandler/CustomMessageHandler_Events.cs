...
namespace xbase.weixin.messagehandle
{
    ...
    public partial class CustomMessageHandler
    {
        private string GetWelcomeInfo()
        {
            ...
            var fileVersionInfo = FileVersionInfo.GetVersionInfo(HttpContext.Current.Server.MapPath("~/bin/xbase.weixin.web.dll"));
...
", version);
        ...
        public override IResponseMessageBase OnEvent_LocationRequest(RequestMessageEvent_Location requestMessage)
        {
            ...
            string s = requestMessage.FromUserName + "\r\n"
                  + requestMessage.Latitude + "\r\n"
                  + requestMessage.Longitude + "\r\n";
            var responseMessage = CreateResponseMessage<ResponseMessageText>();
            try
            {
                PnUser user = WxApi.getUserO(requestMessage.FromUserName);
                responseMessage.Content = "亲爱的" + user.nickname + @":欢迎回来
发送1 ，查看历史信息。
发送2 ，谱写情怀。
发送3 ，上传你的精彩作品。
发送4 ，捐赠平台。";
            ...
            catch (Exception e)
            {
                ...
                if (e.InnerException != null)
                    s1 += e.InnerException.Message;
                try
                {
                    responseMessage.Content = WxApi.getUser(requestMessage.FromUserName) + s1;
                    return responseMessage;
                }
                catch
                {
                    responseMessage.Content = s1;
                    return responseMessage;
                }
            }
        }
