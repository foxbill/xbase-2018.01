...
namespace xbase.weixin.contract
{
    public class PnUser
    {
        ...
        public int subscribe_time { get; set; }   //用户关注时间，为时间戳。如果用户曾多次关注，则取最后关注时间
        ...
        public long groupid { get; set; }      //用户所在的分组ID（兼容旧的用户分组接口）
        public int[] tagid_list { get; set; }   //用户被打上的标签ID列表
    }
}
