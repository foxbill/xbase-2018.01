/*
以下行插入到页面的body部分
<object id="comRD800" codebase="comRD800.dll" classid="clsid:638B238E-EB84-4933-B3C8-854B86140668"></object>
*/
...
function D8Card() {
    ...
    function open() {
        ...
        {
            alert("初始化设备错误，请检查读卡器是否接上，或接上的读卡器是否为D8系列!");
            return;
        }
    }
    ...
    function OnTest() {
        ...
        rd.put_bstrSBuffer_asc = "31323334353637383930313233343533";
        st = rd.dc_write(5);
        if (st != 0) //返回值小于0表示失败
        {
