...
function Page(element) {
    //  function requestInnerHTML(url) {
    //      this.innerHTML = XAjax.SynRequest(url, null);
    //  }
    this.requestInnerHTML = function (url) {
        this.innerHTML = XAjax.SynRequest(url, null);
    }
    var e = document.getElementById(element);
    e.requestInnerHTML = this.requestInnerHTML;
    //    e.requestInnerHTML = requestInnerHTML;
    return e;
}
