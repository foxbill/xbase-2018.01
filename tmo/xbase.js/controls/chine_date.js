...
0x0b5a0, 0x056d0, 0x055b2, 0x049b0, 0x0a577, 0x0a4b0, 0x0aa50, 0x1b255, 0x06d20, 0x0ada0)
    ...
    function Lunar(objDate) {
        ...
        for (var i = 1900; i < 2050 && offset > 0; i++) {
            temp = lYearDays(i)
            offset -= temp
            this.monCyl += 12
        }
...
"1006 老人节", "1024 联合国日", "1112 孙中山诞辰", "1220 澳门回归纪念", "1225 圣诞节", "1226 毛席诞辰")
        ...
        //国历节日
        for (var i in sFtv)
            if ((typeof lFtv[i])=="string" &&  lFtv[i].match(/^(\d{2})(\d{2})([\s\*])(.+)$/)) {
        ...
        if (solarTerms == '' && solarFestival == '' && lunarFestival == '')
            ...
            festival = '<TABLE WIDTH=100% BORDER=0 CELLPADDING=1 CELLSPACING=0 BGCOLOR="#CCFFCC"><TR><TD align=center><marquee direction=left scrolldelay=120 behavior=alternate>' +
    ...
    function refreshCalendarClock() //
    {
        ...
        // showelement.innerHTML = CurentTime();
    }
    //显示当前时间

    function GetCalendar() {
        var s = "<table border='0' cellspacing='1' width='180' bordercolor='#3D637D' bgcolor='#FFFFFF' height='110' cellpadding='2'>"
            + "<tr><td style='text-align:center' align='center'><b>" + YYMMDD() + "<br><font face='Arial' size='6' color=#FF8040>" + SD + "日</font><br>"
          + weekday() +  "<br></b>"
          + solarDay1() + "<br>" + solarDay2() + "<br>" + solarDay3() + "</td></tr></table>";
        return s;
    }
    showelement.innerHTML = GetCalendar();
